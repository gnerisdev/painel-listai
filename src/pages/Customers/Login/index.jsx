...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    try {
      ...
      const response = await apiService.post('/hosts/login', { ...data, subscription });
      ...
      if (!checkSuport()) {
        ...
        setTimeout(() => document.location.href = '/hosts/home', 3000);
      } else {
        return document.location.href = '/hosts/home';
      }
          ...
          <Box sx={{ my: 8, mx: 4, display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
            ...
            <Box component="form" noValidate onSubmit={handleSubmit} sx={{ mt: 1 }}>
              ...
              <Grid container>
                ...
                <Grid item>
                  <Link href="hosts/register" variant="body2">Cadastre-se</Link>
                </Grid>
              </Grid>
              ...
              <Typography variant="body2" color="text.secondary" align="center">
                {'Copyright © '}
                <Link color="inherit" href="https://meuapetite.com/">Casa Clean</Link>
